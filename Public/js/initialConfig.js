...
function addConfig () {
    //add the config to the xml and save
  var dataIn = form.serializeArray();
  //post the data to the "API" which handles the request and will return whether or not there was success
  $.ajax({
